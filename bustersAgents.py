...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for gpd in livingGhostPositionDistributions:
            ...
            print max_pr_pos
            # actions = map(lambda ac: Actions.getSuccessor(pacmanPosition, ac), legal)
            ...
            for action in legal:
                ...
                distance = self.distancer.getDistance(succ_pos, max_pr_pos)

                if distance < min_distance:
                    min_distance, min_action = distance, action

                print " {} distance = {}, action = {}".format(succ_pos, distance, action)
            print " mindistance = {}, minaction = {}".format(min_distance, min_action)
            return min_action
